...
public class SQLQueries {
	...
	public static final String GET_ENROLLED_STUDENTS_1="select course.courseCode,course.courseName,registeredcourse.studentId from course inner join registeredcourse on course.courseCode = registeredcourse.courseCode where course.courseCode = ?";
